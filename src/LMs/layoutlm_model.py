...
from LMs.configuration_CSModel import CSModelConfig
...
class LayoutLMEmbeddings(nn.Module):
    ...
    def _tensor_expand(self, input_tensor, center_size=192, other_size=40):
        row = input_tensor.size()[0]
        col = input_tensor.size()[1]
...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        seg_width: Optional[torch.LongTensor] = None,
        seg_height: Optional[torch.LongTensor] = None, 
        head_mask: Optional[torch.FloatTensor] = None,
